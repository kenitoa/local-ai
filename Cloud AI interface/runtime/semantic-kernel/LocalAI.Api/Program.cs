    ...
    AiModelOptions modelOptions)
{
    ...
    {
        ExpertRegistryPath = ReadPath("ExpertRegistryPath", Path.Combine("Configuration", "expert-registry.json")),
        CompositionProfilesPath = ReadPath("CompositionProfilesPath", Path.Combine("Configuration", "composition-profiles.json")),
        FallbackChainsPath = ReadPath("FallbackChainsPath", Path.Combine("Configuration", "fallback-chains.json")),
        ExpertPermissionsPath = ReadPath("ExpertPermissionsPath", Path.Combine("Configuration", "expert-permissions.json")),
